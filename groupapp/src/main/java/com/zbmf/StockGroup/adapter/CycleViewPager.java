...
import com.zbmf.StockGroup.utils.CycleViewPagerHandler;
import com.zbmf.StockGroup.view.BaseViewPager;
...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	...
	public void setData(List<ImageView> views, List<HomeImage> list, ImageCycleViewListener listener) {
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, List<HomeImage> list, ImageCycleViewListener listener, int showPosition) {
