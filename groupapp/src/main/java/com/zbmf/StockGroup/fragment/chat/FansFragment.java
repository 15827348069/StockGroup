...
public class FansFragment extends BaseFragment implements View.OnClickListener/*, AdapterView.OnItemClickListener */ {
    ...
    protected void initView() {
        ll_tip = getView(R.id.ll_tip);
        psr =  getView(R.id.listview);
        listview = psr.getRefreshableView();
        ed_msg = getView(R.id.ed_msg);
        tv_unread = getView(R.id.tv_unread);
        tv_return =  getView(R.id.tv_return);
        tv_reply =  getView(R.id.tv_reply);
        iv_close =  getView(R.id.iv_close);
        iv_close.setOnClickListener(this);
        tv_unread.setOnClickListener(this);
        tv_reply.setOnClickListener(this);
        getView(R.id.send_layout).setOnClickListener(this);
        getView(R.id.iv_emoji).setOnClickListener(this);
...
//                        imm.showSoftInput(ed_msg,InputMethodManager.SHOW_IMPLICIT);
    ...
    public void fragmentregisterReceiver() {
        ...
        filter.addAction(Constants.FANS_CHAT_MSG);
