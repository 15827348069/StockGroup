...
public class ShowWebShareLayout implements WbShareCallback {
            ...
            public void onClick(View v) {
                ...
                AsyncTask.execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        IWXAPI api = WXAPIFactory.createWXAPI(webActivity, Constants.WEI_APK_KEY,true);
                        api.sendReq(req);
                    }
                });
                aDialog.dismiss();
    ...
    private String getActivitySharedText(String activity_time) {
        ...
        String text = String.format(format,webActivity.getString(R.string.app_name)+"分享【"+activity_time+"】");
        return text;
    }
    public void shareQQ(ShareBean ab){
        ...
        Tencent mTencent= Tencent.createInstance(Constants.TencentSDKAppKey,webActivity);
