...
public class CustomMyCProgress extends View {
    ...
    public CustomMyCProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CustomMyCProgress, defStyleAttr, 0);
    ...
    private void initAttributes(TypedArray typedArray) {
        mFinishedStrokeColor = typedArray.getColor(R.styleable.CustomMyCProgress_finished_color, default_finished_color);
        mUnfinishedStrokeColor = typedArray.getColor(R.styleable.CustomMyCProgress_unfinished_color, default_unfinished_color);
        text_color = typedArray.getColor(R.styleable.CustomMyCProgress_text_color, default_text_color);
        textSize = typedArray.getDimension(R.styleable.CustomMyCProgress_text_size, default_text_size);
        progress_color = typedArray.getColor(R.styleable.CustomMyCProgress_progress_text_color, default_text_color);
        progress_textSize = typedArray.getDimension(R.styleable.CustomMyCProgress_progress_text_size, default_text_size);
        setMax(typedArray.getInt(R.styleable.CustomMyCProgress_progress_max, default_max));
        setProgress(typedArray.getFloat(R.styleable.CustomMyCProgress_custom_progress, 0));
        mFinishedStrokeWidth = typedArray.getDimension(R.styleable.CustomMyCProgress_finished_stroke_width, default_stroke_width);
        mUnfinishedStrokeWidthWidth = typedArray.getDimension(R.styleable.CustomMyCProgress_unfinished_stroke_width, default_stroke_width);
        startingDegree = typedArray.getInt(R.styleable.CustomMyCProgress_circle_starting_degree, default_startingDegree);
        innerBackgroundColor = typedArray.getColor(R.styleable.CustomMyCProgress_background_color, default_inner_background_color);
        type=typedArray.getString(R.styleable.CustomMyCProgress_type);
        defaultTextStr=typedArray.getString(R.styleable.CustomMyCProgress_text);
    }
