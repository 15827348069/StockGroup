...
#保留自定义组件不被混淆
-keep class com.zbmf.StockGroup.view**{*;}
...
#蒲公英混淆
#-libraryjars libs/pgyer_sdk_2.6.8.jar
...
-keep class com.jakewharton.**{*;}
 ...
 #不混淆android-async-http-1.4.5.jar
-dontwarn android-async-http-1.4.5.jar.**
-keep class android-async-http-1.4.5.jar.**{*;}
