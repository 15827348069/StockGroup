...
public class CouponsAdapter extends BaseAdapter {
    ...
    public CouponsAdapter (Context context,List<CouponsBean>infolist,CompoundButton.OnCheckedChangeListener listener){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(cb.is_take()){
            ...
            item.clcil_coupons.setOnCheckedChangeListener(listener);
        }else{
            item.clcil_coupons.setText("已领取");
            item.clcil_coupons.setVisibility(View.GONE);
            item.clcil_coupons.setOnCheckedChangeListener(null);
