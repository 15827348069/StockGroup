...
public class CycleViewPager <T> extends Fragment implements OnPageChangeListener {
	...
	private CycleViewPagerHandler handler= new CycleViewPagerHandler(getActivity()) {
	...
	public void setData(List<ImageView> views, List list, ImageCycleViewListener listener) {
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, List list, ImageCycleViewListener listener, int showPosition) {
...
//		viewPager.setOffscreenPageLimit(indicators.length);
	...
	public void setIndicatorLayout(int vis){
		if(indicatorLayout!=null){
			indicatorLayout.setVisibility(vis);
		}
	}
	/**
	 ...
	 * @author minking
	 */
	public static interface ImageCycleViewListener<T> {
		 ...
		 * @param imageView
		 */
		public void onImageClick(T info, int position, View imageView);
	}
	...
	public void setLayoutParam(){
		if(viewPagerFragmentLayout!=null){
			...
			ViewGroup.LayoutParams layoutParams=viewPagerFragmentLayout.getLayoutParams();
			layoutParams.height=screenWidth/3;
			viewPagerFragmentLayout.setLayoutParams(layoutParams);
		}
	}
}