...
import com.zbmf.StocksMatch.listener.MZViewHolder;
import com.zbmf.StocksMatch.util.CoverModeTransformer;
import com.zbmf.StocksMatch.util.ScaleYTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    /**
     * 开始轮播
     * <p>应该确保在调用用了{@link MZBannerView {@link #setPages(List, List,MZHolderCreator)}} 之后调用这个方法开始轮播</p>
     */
    public void start(){
...
//    }
     ...
     */
    public static final int mDuration = 800;
